...
export default async function AccountPage() {
  ...
  return (
    <>
      <PageHeader
        title="帳號與設定"
        description="確認目前登入帳號、切換帳號、登出，並設定手機推播通知。"
        actions={<LinkButton href="/" variant="secondary"><Home className="h-5 w-5" />首頁</LinkButton>}
      />
        ...
        <div className="grid gap-5">
          ...
          <Panel>
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-base font-semibold text-slate-600">多人共用電腦或手機測試時，請切換帳號或登出。</p>
              </div>
            </div>
          ...
          <Panel className="border-amber-200 bg-amber-50">
            ...
            <p className="mt-2 text-base font-semibold leading-7 text-amber-950">
              測試帳號請勿轉傳給非測試人員。正式上線前會改成每位同仁自己的帳號與密碼。
            </p>
          </Panel>
        </div>
          ...
          <div className="mb-5 flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-2 text-base font-semibold leading-7 text-slate-700">
                iPhone 請從主畫面 PWA 開啟後啟用推播；啟用後可測試鎖定畫面、通知中心與點擊跳轉。
              </p>
            </div>
